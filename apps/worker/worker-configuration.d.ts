/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/worker/wrangler.toml --env=staging apps/worker/worker-configuration.d.ts` (hash: 6900eebd6fbcee9091f7dec27e8d480f)
