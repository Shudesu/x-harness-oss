/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/worker/wrangler.toml --env=staging apps/worker/worker-configuration.d.ts` (hash: 3d42662dbd5d2f6bfe67f7731b2ecb05)
